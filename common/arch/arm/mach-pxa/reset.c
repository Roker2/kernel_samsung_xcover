...
{
#ifdef CONFIG_SND_SOC_88PM860X_AUDIO
	/* 88PM860X AUDIO path must be closed gracefully before reset */
	extern void pm860x_audio_shutdown(void);
	pm860x_audio_shutdown();
#endif

...
IMPC extern void OSADeInitialize(void);
...
typedef struct
{
    ...
    UINT32              bSharedForIpc ;             //  [OP]    TRUE - The object can be accessed from all processes.
}
...
typedef struct
{
    UINT32      *SisrStackPtr[OSA_SISR_MAX_PRIORITY] ;     //  [OP,IN] SISR Stack Pointers.
    UINT32      SisrStackSize[OSA_SISR_MAX_PRIORITY] ;     //  [IN]    SISR Stack Size.
}
OsaInitParamsT ;
 ...
 ****************************************************************************/
      ...
      __attribute__((noreturn)) void OSA_AssertFail(char *file, unsigned line);     /* Assert Fail function */          //-+ GQ00000296 telephony: coverity fixes in osa hwmap nvms eeh fake +-
